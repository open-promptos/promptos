 ...
 */
exports.builtinAbilities = [
    // 1) code.explain
    {
        id: "code.explain",
        description: "Explain complex code, regex, or algorithms in plain language.",
    ...
    // 2) code.review.api
    {
        ...
        examples: [
            {
                ...
                description: "Review a TypeScript HTTP API module with strict standards.",
            },
        ],
        supportedLanguages: [
            "typescript",
        ...
        languageSpecificHints: {
            typescript: "You are a senior TypeScript engineer. Pay attention to type safety and generics.",
            python: "You are a senior Python engineer. Pay attention to Pythonic conventions.",
            // ... 其他语言提示可按需保留
        },
    },
    // 3) write.tech.spec
    {
        id: "write.tech.spec",
        description: "Draft a clear and structured technical specification or design doc.",
...
//# sourceMappingURL=builtinAbilities.js.map